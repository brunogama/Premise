...
public struct Z3VersionPolicy: Sendable, Equatable {
  /// The minimum Z3 major version supported by PremiseSMT.
  public static let minimumMajor: UInt32 = 4

  /// The minimum Z3 minor version supported by PremiseSMT.
  public static let minimumMinor: UInt32 = 12

  /// The minimum Z3 patch version supported by PremiseSMT.
